...
- `setupkvm()`: カーネルのページテーブルを作成(Fig2-2)
    - `vm.c`
    ...
    - L124 - 126: `pgdir`(ページディレクトリエントリ)の領域を確保
        - 4096/32=128[pte]
    ...
    - L129 - 134: `pgdir`を`kmap[]`にあわせてカーネルのページテーブルを作っていく
        - `mappages()`: 仮想アドレスと物理アドレスを紐づける
            ...
            - `walkpgdir()`: `va`に対応するページエントリを見つける
                - `vm.c`
